    ...
    sections: [
      {
        title: 'Sports',
        description: [
          `For more than 15 years, I played football, futsal and basketball, at
      ...
      },
      {
        ...
        `,
          `Also led a 25-member international guild in World of Warcraft for a
